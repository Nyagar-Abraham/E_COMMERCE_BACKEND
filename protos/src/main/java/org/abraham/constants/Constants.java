...
public class Constants {
    ...
    public static final Set<String> PUBLIC_METHODS = ImmutableSet.of("loginUser", "registerUser","verifyEmailToken");
    public static final String VERIFY_MFA_METHOD = "verifyMfaCode";
